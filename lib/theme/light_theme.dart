...
ThemeData light = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFF038446),
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF038446))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF038446), secondary: Color(0xFF038446)).copyWith(error: const Color(0xFFE84D4F)),
